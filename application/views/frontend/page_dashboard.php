<?php $this->load->view("template3_header"); ?>
<style>
    #xmyCarousel .active > img {
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <div class="container">
            ...
            <div class="page-content-inner">
                <div class="mt-content-body" style="margin-top: -15px;">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="portlet">
                                <div class="row">
                                    <div id="myCarousel"
                                         class="carousel slide col-md-12 col-sm-12"
                                         data-ride="carousel">
                                        <!-- Indicators -->
                                        ...
                                        <div class="carousel-inner text-center">
                                            ...
                                            <div class="item active">
                                                ...
                                                <div class="item">
                                                    <?php } ?>
                                                    <img src="<?php echo base_url() ?>assets/uploads/carousel/<?php echo $img['img'] ?>"
                                                         alt="This is image from CRUD"
                                                         style="width:100%;left: auto;">
                                                    <div class="carousel-caption">
                                                        <h3><?php echo $img['carousel_caption'] ?></h3>
                                                        <p><a href="http://<?php echo $img['external_link'] ?>" target="_blank">
                                                                <?php echo $img['external_link'] ?>
                                                        </a></p>
                                                    </div>
                                                </div>
                                                <?php $i++;
                                                    ...
                                                    <a href="#tab_15_1"
                                                       data-toggle="tab">
                                                        <div class="caption caption-md">
                                                            ...
                                                            <span class="caption-subject font-black-steel bold uppercase">Berita Utama</span>
                                                        </div>
                                                    </a>
                                                </li>
                                            </ul>
                                            ...
                                            <ul class="nav nav-tabs">
                                                <li class="active">
                                                    <a href="#tab_15_1"
                                                       data-toggle="tab">
                                                        <div class="caption caption-md">
                                                            <small><span class="caption-subject font-black-steel bold uppercase">Berita</span></small>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#tab_15_2"
                                                       data-toggle="tab">
                                                        <div class="caption caption-md">
                                                            <small><span class="caption-subject font-black-steel bold uppercase">Siaran Pers</span></small>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#tab_15_3"
                                                       data-toggle="tab">
                                                        <div class="caption caption-md">
                                                            <small><span class="caption-subject font-black-steel bold uppercase">Pengumuman</span></small>
                                                        </div>
                                                    </a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <a href="#tab_15_1"
                                                       data-toggle="tab">
                                                        <div class="caption caption-md">
                                                            ...
                                                            <span class="caption-subject font-black-steel bold uppercase">Infografis</span>
                                                        </div>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-black-steel bold uppercase">Berita Subsektoral</span>
                                        </div>
                                        <ul class="nav nav-tabs">
                                            <li class="active">
    ...
    <?php $this->load->view("template3_footer"); ?>
    <!--<script>-->
