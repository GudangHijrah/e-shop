<div class="portlet-body">
            ...
            <div class="tab-pane active" id="tab_statistik">
                <div class="row">
                    <div class="col-xs-12" style="padding: 0;">
                        <div id="infografCarousel"
                             class="custom-carousel carousel slide col-md-12 col-sm-12 indicator"
                             data-ride="carousel">
                            <ol class="carousel-indicators">
                                <?php if (!empty($_infografis)) { ?>
                                    <?php $i = 0;
                                    foreach ($_infografis as $gal) {
                                        if ($i == 0) { ?>
                                            <li data-target="#infografCarousel" data-slide-to="0" class="active"></li>
                                        <?php } else { ?>
                                            <li data-target="#infografCarousel" data-slide-to="<?php echo $i; ?>"></li>
                                        <?php } ?>
                                        <?php $i++;
                                    } ?>
                                <?php } else { ?>
                                    <li data-target="#infografCarousel" data-slide-to="0" class="active"></li>
                                    <li data-target="#infografCarousel" data-slide-to="1"></li>
                                <?php } ?>
                            </ol>
    ...
    <a title="Selengkapnya" class="btn btn-default btn-sm"
       href="<?php echo site_url('frontend/download_index?kode_category=infografis'); ?>">Selengkapnya <i class="fa fa-angle-double-right"></i></a>
</div>