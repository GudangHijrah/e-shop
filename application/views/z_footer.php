...
<p class="copyright"> 2017 &copy;
    <a target="_blank" href="http://sumberdayaair.jakarta.go.id/">Dinas Tata Air Provinsi DKI Jakarta</a> &nbsp;|&nbsp;
    All Right Reserved
</p>
...
<!--<script src="--><?php //echo base_url('assets/global/plugins/counterup/jquery.counterup.min.') ?><!--" type="text/javascript"></script>-->
