            ...
            <div class="page-content-col">
                ...
                <div class="row margin-bottom-40">
                    <div class="col-lg-6">
                        <div class="portlet light about-text">
                            ...
                            <p class="margin-top-20"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
                            ...
                            <div class="about-quote">
                                <h3>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                                    nibh</h3>
                ...
                <div class="row margin-bottom-20 stories-cont">
                    <div class="col-lg-3 col-md-6">
                        <div class="portlet light">
                            <div class="photo">
                                <img src="<?php echo base_url('assets/pages/media/users/teambg1.jpg') ?>" alt=""
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="portlet light">
                            <div class="photo">
                                <img src="<?php echo base_url('assets/pages/media/users/teambg2.jpg') ?>" alt=""
                                     class="img-responsive"/></div>
                            <div class="title">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="portlet light">
                            <div class="photo">
                                <img src="<?php echo base_url('assets/pages/media/users/teambg5.jpg') ?>" alt=""
                                     class="img-responsive"/></div>
                            <div class="title">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="portlet light">
                            <div class="photo">
                                <img src="<?php echo base_url('assets/pages/media/users/teambg8.jpg') ?>" alt=""
                                     class="img-responsive"/></div>
                            <div class="title">
                                <span> Tom Brady </span>
                            </div>
                ...
                <div class="row about-links-cont" data-auto-height="true">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="about-image"
                             style="background: url(<?php echo base_url('assets/pages/media/works/img4.jpg'); ?>) center no-repeat;"></div>
                    </div>
                </div>
                <!-- END LINKS BLOCK -->
...
<script>
    $( document ).ready(function() {
        $( "#tab2").addClass( "active open selected" );
    });
</script>
