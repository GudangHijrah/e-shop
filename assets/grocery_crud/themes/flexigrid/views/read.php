...
<div id='main-table-box'>
	...
	<div class='form-div'>
		...
		?>
			<div class='form-field-box <?php echo $even_odd?>' id="<?php echo $field->field_name; ?>_field_box">
				...
				<div class='form-input-box' id="<?php echo $field->field_name; ?>_input_box" style="margin-top: 0px;">
	...
	<div class="pDiv" style="padding-left: 200px;">
		<div class='form-button-box'>
			<input type='button' value='<?php echo $this->l('form_back_to_list'); ?>' class="btn btn-large back-to-list btn-warning" id="cancel-button" />
		</div>
		<div class='form-button-box'>
