...
To use the widget you must include _jQuery_ and _jQuery UI_ bundle (including `ui.xcore`, `ui.widget`, `ui.button`, 
	...
	_initUploader: function() {
		...
		uploader.bind('FilesAdded', function(up, files) {
			...
			if (self.options.autostart) {
				// set a little delay to make sure that QueueChanged triggered by the xcore has time to complete
				setTimeout(function() {
					self.start();
				}, 10);
			}
